...
\vspace{0.2cm}
\\
\textsc{Conferences} & \textbf{Presentations}

\vspace*{0.2cm}
\textit{Coupling Between Ice Dynamics and Subglacial Hydrology}, SIAM Conference on Computational Science and Engineering, Atlanta, GA, Feb 27-Mar 3, 2017.

\vspace*{0.2cm}
\textit{Coupling Between Ice Sheets Movement and Subglacial Hydrology}, SIAM Conference on Mathematics of Planet Earth, Philadelphia, PA, Sep 30-Oct 2, 2016.

\vspace*{0.2cm}
\textit{Estimation of the coefficients in a Coulomb friction boundary condition for ice sheets sliding on bedrocks}, SIAM Conference on Uncertainty Quantification, Lausanne, Switzerland, Apr 5-8, 2016.

\vspace*{0.2cm}
\textit{A POD approach for in vivo estimation of arterial compliance from medical images}, 12th U.S. National Congress on Computational Mechanics USNCCM12, Raleigh, NC, Jul 22-25, 2013.

\vspace*{0.2cm}
\textit{Model reduction for parameter estimation in computational hemodynamics}, SIAM Conference on Computational Science and Engineering, Boston, MA, Feb 25-Mar 1, 2013.
